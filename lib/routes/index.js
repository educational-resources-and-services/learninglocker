...
const routes = [
  ...
  { name: 'organisation.data.visualise.visualisation', path: '/:visualisationId' },
  { name: 'organisation.data.source', path: '/source' },
  { name: 'organisation.data.aggregate', path: '/aggregate' },
  { name: 'organisation.data.statementForwarding', path: '/statementforwarding' },

  { name: 'organisation.people', path: '/people' },

  { name: 'organisation.people.imports', path: '/imports' },
  { name: 'organisation.people.manage', path: '/manage' },
  { name: 'organisation.people.manage.persona', path: '/:personaId' },
